...
Resource    /home/pbudczak/git_repos/robot/resources/imports.robot


Suite Setup     Setup  Test Execution Paused. Play game until you win the round, then click OK.
...
Check getaccount request
    ...
    And request=getaccount doesn't contain any other parameter
...
Check getbalance request
    ...
    And request=getbalance doesn't contain any other parameter
...
Check wager request
    ...
    And request=wager doesn't contain any other parameter
...
Check result request with gamestatus=completed
    ...
    And request=result must contain gamedetails parameter
